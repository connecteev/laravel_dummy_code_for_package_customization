...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased min-h-screen bg-white lg:bg-gray-300" }, _attrs))}><div class="lg:min-h-screen bg flex flex-wrap lg:flex-nowrap"><div class="order-last lg:order-first lg:max-w-md py-10 lg:pt-24 px-6 bg-white lg:shadow-lg" id="sideBar">`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/MyPortal.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const MyPortal = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  MyPortal as default
};
