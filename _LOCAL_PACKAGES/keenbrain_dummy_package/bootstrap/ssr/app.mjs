...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/BillingPortal.vue": () => import("./assets/BillingPortal-f96c8bb6.mjs"), "./Pages/Foo.vue": () => import("./assets/Foo-a402c3f2.mjs") })),
  setup({ el, App, props, plugin }) {
    return createSSRApp({ render: () => h$1(App, props) }).use(plugin).use($, Ziggy).mount(el);
  },
  progress: {
    color: "#4B5563"
  }
