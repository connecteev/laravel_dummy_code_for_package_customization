...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Foo.vue": () => import("./assets/Foo-a402c3f2.mjs"), "./Pages/MyPortal.vue": () => import("./assets/MyPortal-543e4df0.mjs") })),
